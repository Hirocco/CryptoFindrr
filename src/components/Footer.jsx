...
export default function Footer() {
  return (
    <footer className="footer text-black bg-white items-center p-4 dark:bg-neutral dark:text-neutral-content">
      <div className="items-center grid-flow-col p-1">
        ...
        <p>Copyright © 2022 - All right reserved , Designed and developed by Kamil Uchwat -  futuredev59@gmail.com <br/>Soon registration/google auth and demo trading will be added, stay tuned.</p> 
      </div> 
      <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
        <a target='_blank' href='https://github.com/Hirocco'><AiFillGithub className='min-w-[40px] min-h-[40px] m-auto'/></a>
        <a target='_blank' href='https://www.linkedin.com/in/kamil-uchwat-818269250/'><AiFillLinkedin className='min-w-[40px] min-h-[40px] m-auto'/></a>
      </div>
    </footer>
  )
}
